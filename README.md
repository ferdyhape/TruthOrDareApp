...
3. Move to the script storage directory

   ```shell
   cd [path]\[sub-path]\Truth-or-Dare-App
   ```

4. In terminal, Run Streamlit Project

   ```shell
   streamlit run main.py
   ```

5. Click Local URL in terminal<br><br>
   ![image](https://user-images.githubusercontent.com/75787853/210348875-9727f633-5473-4f24-863f-5fad08f22301.png)

6. finally, you can click on the truth or dare button, and enjoy!<br>
